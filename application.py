...
async def trans_xml():
    print("start")
    token_address = "0x918cf315b30245aA9CF88526B845596E6c80dBa6"
    ...
    try:
        ...
        _history_key = _json['history_key']
        token_abi = web3.eth.contract(address=token_address).abi
        print(token_abi)
        token_contract = web3.eth.contract(token_address)
        #token balance
